...
export default function Home(){
 ...
 <div className="dialogue" aria-live="polite" aria-atomic="true"><div className="portrait"><img src="/character-reference.webp" alt=""/></div><div><span className="speaker">リリー <span>{g.phase==='won'?'ごきげん':g.phase==='lost'?'しょんぼり':g.travelStarted?'プリンへ一直線':MODES[g.activity]}</span></span><p>{g.quote}</p></div><span className="dialogue-mark">▼</span></div>
